    ...
    return (
        <>
            ...
            >
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            ...
                            <p className="text-lg sm:text-xl text-muted-foreground">
                                ...
                                Každý den připravujeme kávu s láskou a k tomu chystáme čerstvé chlebíčky a panini. Cukroví máme od tří dodavatelů – vždy čerstvé a plné lahodné chuti.
                            </p>
                ...
                <div className="container-default max-w-3xl py-48 mx-auto flex flex-col items-center gap-8">
                    <motion.img
                        src={petFriendly}
                    ...
                    >
                        Věříme, že chvíle u kávy chutnají nejlépe ve společnosti těch, které máme rádi – ať už jsou dvounozí nebo čtyřnozí. U nás jsou vaši mazlíčci vítáni.
                    </motion.p>
                </div>
            </section>
