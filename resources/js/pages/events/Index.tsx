        ...
        <PageTransition>
            <div className="min-h-screen bg-background text-foreground">
                ...
                <motion.section
                    ...
                    className="relative overflow-hidden pt-32 pb-20 bg-gradient-to-b from-background via-secondary/10 to-background text-center"
                >
                ...
                {/* LIST */}
                <section className="pb-40 relative overflow-hidden bg-background">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                                {events.map((event, i) => (
                                    <motion.div
                                        ...
                                        viewport={{ once: true }}
                                        className="bg-card border border-border rounded-3xl overflow-hidden shadow-elegant group hover:-translate-y-1 hover:shadow-luxury transition-all duration-500"
                                    >
                                        ...
                                        <div className="p-6 flex flex-col justify-between h-full">
                                            <div>
                                                <Badge className="mb-3 bg-gradient-primary text-primary-foreground shadow-sm">
                                                    {event.category}
                                                </Badge>
